(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('element-ui'), require('lodash')) :
  typeof define === 'function' && define.amd ? define(['element-ui', 'lodash'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.index = factory(global.elementUi, global.lodash));
})(this, (function (elementUi, lodash) { 'use strict';
    ...
    mounted() {
      ...
      this.$on('current-change', (currentVal) => {
        if (this.highlightCurrent) {
          // 需要高亮的情况
          !lodash.isEmpty(this.currentSelectNode) && (this.currentSelectNode.node.active = !this.currentSelectNode.node.active);
